                ...
                if (optionalEmailCode.isPresent()) {
                    ...
                    Logyee.instance.runTaskAsync(() -> {
                        try {
                            ...
                            Bukkit.getScheduler().runTask(Logyee.instance, () -> sender.sendMessage(Config.Language.RESETPASSWORD_EMAIL_WARN));
                            e.printStackTrace();
                        }
                    });
                }
